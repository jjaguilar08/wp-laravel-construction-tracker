<x-app-layout>
    <x-slot name="header">
        <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            ...
            <a href="{{ route('income-expectations.create') }}" class="inline-flex items-center justify-center rounded-full bg-[#f6a06b] px-4 py-2 font-['Caprasimo'] text-xs uppercase tracking-widest text-[#2e2b25] transition hover:bg-[#ffc6a5] active:bg-[#d67f48]">
                Set Expected Income
            </a>
        </div>
    </x-slot>
