...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="bg-gray-50 text-gray-900 antialiased">
        <div class="mx-auto max-w-5xl px-6 py-10">
            ...
            @else
                <form method="GET" action="{{ route('dashboard') }}" class="mt-8 flex flex-wrap items-end gap-4 rounded-lg border border-gray-200 bg-white p-4">
                    <div>
                    ...
                    <div class="flex gap-2">
                        ...
                        <a href="{{ route('dashboard') }}" class="rounded-md border border-gray-300 px-4 py-2 text-sm font-medium text-gray-600">Clear</a>
                    </div>
                </form>
