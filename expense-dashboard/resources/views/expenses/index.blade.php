    ...
    <div class="py-12">
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8 space-y-4">
            ...
            <div class="flex justify-end">
                <a href="{{ route('expenses.create') }}" class="rounded-md bg-gray-900 px-4 py-2 text-sm font-medium text-white">
                    Add Expense
                </a>
            </div>
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200 text-sm">
                        ...
                        <tbody class="divide-y divide-gray-100">
                            ...
                            @empty
                                <tr>
                                    <td colspan="5" class="px-4 py-6 text-center text-gray-400">No expenses yet.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
